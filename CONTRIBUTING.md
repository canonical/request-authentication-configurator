...
```shell
tox run -e update-requirements   # update locked dependencies according to dependency requirements
tox run -e fmt                   # update your code according to linting rules
tox run -e lint                  # code style
tox run -e unit                  # unit tests
tox run -e integration           # integration tests
tox                              # runs 'update-requirements', 'fmt', 'lint', 'unit' and 'integration' environments
```
